document.addEventListener('DOMContentLoaded', (event) => {
	...
	// Function to quickly call elements less typing means less chance for errors
	...
	// Function to set the options in the questions
	let setQuestionData = () => {
	...
	// Function for the timer in events
	let myTimer = () => {
		if (time > 0) {
			time = time - 1;
			queryElement('#time').innerHTML = time;
